...
from xmlbuilder3 import XMLBuilder
...
class TestXMLBuilder(object):
    ...
    @raises(ValueError)
    def test_wrong_data4(self):
        self.xml.t(True, attr=3)

    @raises(ValueError)
    def test_wrong_data5(self):
        self.xml.t(3)

    test_formatter1_res = """<root>
    <t1 m="1">
        <t2 />
    </t1>
    <t3>mmm</t3>
